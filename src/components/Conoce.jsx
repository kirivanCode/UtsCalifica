    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <header className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-5xl sm:text-6xl font-bold mb-4">UTS CALIFICA<span className="text-red-500">X</span></h1>
          <p className="text-lg sm:text-xl mb-8 max-w-lg mx-auto">Revolucionando el sistema de calificaciones</p>
